...
- **[VS Code IntelliSense Setup](vscode-setup.md)** - Configure Visual Studio Code for proper IntelliSense and autocomplete with iOS and Android bindings
...
| ---------------------------------------------------------- | ---------------------------------- | ------------------------ |
| [GETTING_STARTED.md](./GETTING_STARTED.md)                 | How to use the packages            | Package consumers        |
| [VSCODE_SETUP.md](./VSCODE_SETUP.md)                       | VS Code IntelliSense configuration | Contributors             |
| [QUICK_START.md](./QUICK_START.md)                         | Common development tasks           | Contributors             |
| [SDK_UPDATE_GUIDE.md](./SDK_UPDATE_GUIDE.md)               | Update SDK versions                | Contributors/Maintainers |
| [BUILDING_AND_VERSIONING.md](./BUILDING_AND_VERSIONING.md) | Build system details               | Contributors/Maintainers |
| [LOCAL_BUILD_README.md](./LOCAL_BUILD_README.md)           | Local development builds           | Contributors             |
| [RELEASE_PROCESS.md](./RELEASE_PROCESS.md)                 | Publishing workflow                | Maintainers              |
| [ANDROID_NDK_SETUP.md](./ANDROID_NDK_SETUP.md)             | Android NDK configuration          | Contributors             |
| [SETUP_NUGET_README.md](./SETUP_NUGET_README.md)           | NuGet setup                        | Contributors             |
