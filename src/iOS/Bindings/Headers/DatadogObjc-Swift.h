...
SWIFT_CLASS("_TtC11DatadogObjc19DDRUMViewEventDDCLS")
...
@class DDRUMViewEventViewSlowFrames;
...
SWIFT_CLASS("_TtC11DatadogObjc28DDRUMViewEventViewSlowFrames")
